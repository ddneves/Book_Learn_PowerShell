...
Invoke-Parallel -AsJob -Credential $cred -ComputerName $_.dnshostname -UseSSL -SessionOption (New-PSSessionOption -IncludePortInSPN) -Port 5986 -ArgumentList $Username,$SecurePassword -ScriptBlock {
write-host 'test' }
